...
function(c4_setup_static_analysis umbrella_option)
    if(WIN32)
        message(STATUS "${_c4_prefix}: no static analyzer available in WIN32")
        return()
    endif()
    ...
    cmake_dependent_option(${_c4_uprefix}LINT "add static analyzer targets" ON ${umbrella_option} OFF)
    cmake_dependent_option(${_c4_uprefix}LINT_TESTS "add tests to run static analyzer targets" ON ${umbrella_option} OFF)
    # options for individual lints - contingent on linting on/off
    cmake_dependent_option(${_c4_uprefix}LINT_CLANG_TIDY "use the clang-tidy static analyzer" ON "${_c4_uprefix}LINT" OFF)
    cmake_dependent_option(${_c4_uprefix}LINT_PVS_STUDIO "use the PVS-Studio static analyzer https://www.viva64.com/en/b/0457/" OFF "${_c4_uprefix}LINT" OFF)
