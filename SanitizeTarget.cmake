...
function(_sanitize_set_target_folder tgt folder)
    message(STATUS "AQUI 1: ${tgt} ${folder}")
    if(folder)
    message(STATUS "AQUI 2: ${tgt} ${folder}")
...
function(sanitize_target name prefix)
    ...
    if(${oprefix}ASAN AND NOT TARGET ${prefix}asan)
        add_custom_target(${prefix}asan)
        add_dependencies(${prefix}sanitize ${prefix}asan)
        _sanitize_set_target_folder(${prefix}asan ${_c4st_FOLDER})
    endif()
    if(${oprefix}MSAN AND NOT TARGET ${prefix}msan)
        add_custom_target(${prefix}msan)
        add_dependencies(${prefix}sanitize ${prefix}msan)
        _sanitize_set_target_folder(${prefix}msan ${_c4st_FOLDER})
    endif()
    if(${oprefix}TSAN AND NOT TARGET ${prefix}tsan)
        add_custom_target(${prefix}tsan)
        add_dependencies(${prefix}sanitize ${prefix}tsan)
        _sanitize_set_target_folder(${prefix}tsan ${_c4st_FOLDER})
    endif()
    if(${oprefix}UBSAN AND NOT TARGET ${prefix}ubsan)
        add_custom_target(${prefix}ubsan)
        add_dependencies(${prefix}sanitize ${prefix}ubsan)
        _sanitize_set_target_folder(${prefix}ubsan ${_c4st_FOLDER})
    endif()
    ...
    if(${oprefix}ASAN)
        ...
        add_dependencies(${prefix}asan ${name}-asan)
    endif()
    ...
    if(${oprefix}TSAN)
        ...
        add_dependencies(${prefix}tsan ${name}-tsan)
    endif()
    ...
    if(${oprefix}MSAN)
        ...
        add_dependencies(${prefix}msan ${name}-msan)
    endif()
    ...
    if(${oprefix}UBSAN)
        ...
        add_dependencies(${prefix}ubsan ${name}-ubsan)
    endif()
