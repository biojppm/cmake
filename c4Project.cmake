...
function(c4_setup_coverage)
    ...
    separate_arguments(_LCOV_ARGS NATIVE_COMMAND ${_LCOV_ARGS})
    ...
    add_custom_command(OUTPUT ${coverage_result} ${lcov_result}
        ...
        COMMAND ${LCOV} ${_LCOV_ARGS} -q --zerocounters --directory .
        COMMAND ${LCOV} ${_LCOV_ARGS} -q --no-external --capture --base-directory "${sd}" --directory . --output-file ${bd}/coverage0-before.lcov --initial
        ...
        COMMAND ${LCOV} ${_LCOV_ARGS} -q --no-external --capture --base-directory "${sd}" --directory . --output-file ${bd}/coverage1-after.lcov
        COMMAND ${LCOV} ${_LCOV_ARGS} -q --add-tracefile ${bd}/coverage0-before.lcov --add-tracefile ${bd}/coverage1-after.lcov --output-file ${bd}/coverage2-final.lcov
        COMMAND ${LCOV} ${_LCOV_ARGS} -q --remove ${bd}/coverage2-final.lcov ${_EXCLUDE} ${EXCLUDE_ABS} --output-file ${bd}/coverage3-final_filtered.lcov
